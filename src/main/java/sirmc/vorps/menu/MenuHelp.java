...
public class MenuHelp {
	public static void HubMenuHelp(PlayerHub playerHub){
		...
		menuHelp.setItem(9, new Item(Material.BOOK).withName("§6Pour bien débuter").withLore(new String[] {"§7Aide §aPour bien débuter sur le serveur §6§n"+Settings.getNameServer()}).get());
		...
		menuHelp.setItem(10, new Item(Material.BOOK).withName("§6Amis & Party").withLore(new String[] {"§7Comment bien gérer ses §a§namis§7 et ses §a§nparty"}).get());
		...
		menuHelp.setItem(11, new Item(Material.BOOK).withName("§6Grades").withLore(new String[] {"§7Informations concernants sur les grades du serveur §6§n"+Settings.getNameServer()}).get());
		...
		menuHelp.setItem(12, new Item(Material.BOOK).withName("§6Economie du serveur").withLore(new String[] {"§7L'économie pour les nuls"}).get());
		...
		menuHelp.setItem(14, new Item(Material.BOOK).withName("§6HitIt !").withLore(new String[] {"§7Informations sur le mode de jeu §a§nHitIt"}).get());
		...
		menuHelp.setItem(15, new Item(Material.BOOK).withName("§6Rush").withLore(new String[] {"§7Informations sur le mode de jeux §a§nRush"}).get());
		...
		menuHelp.setItem(16, new Item(Material.BOOK).withName("§6Grades").withLore(new String[] {"§7Informations sur le mode de jeux §a§nSkyWars"}).get());
		...
		menuHelp.setItem(17, new Item(Material.BOOK).withName("§6LuckyFight").withLore(new String[] {"§7Informations sur le mode de jeux §a§nLuckyFight"}).get());
