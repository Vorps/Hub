 ...
 */
public class MenuJumpDifficulty extends MenuRecursive{
    ...
    public static void createMenu(UUID uuid, Jumps jumps){
        ...
        /*for(JumpDifficulty jumpDifficulty : jumps.getJumpDifficulty()){
            list.add(jumpDifficulty.getIcon(PlayerData.getLang(uuid)).withLore(jumpDifficulty.getLore(jumps.getJump())));
        }*/
